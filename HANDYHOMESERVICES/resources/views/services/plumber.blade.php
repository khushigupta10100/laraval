...
<body>
    ...
    <div class="services-container">
        <div class="service-card">
            ...
            <img src="plumber1.jpg" alt="Profile Photo">
            <h2>Name: Ramesh Tyagi</h2>
            <p>Age: 25</p>
            <p>Gender: Male</p>
            <p>Type: Full time</p>
            <p>"Reliable plumbing solutions with a touch of expertise. We're your go-to team for fixing leaks and
                keeping pipes pristine."
        ...
        <div class="service-card">
            ...
            <img src="plumber2.jpg" alt="Profile Photo">
            <h2>Name: Suresh Rai</h2>
            <p>Age: 25</p>
            <p>Gender: Male</p>
        ...
        <div class="service-card">
            ...
            <img src="plumber3.jpg" alt="Profile Photo">
            <h2>Name: Lal Gupta</h2>
            <p>Age: 22</p>
            <p>Gender: Male</p>
            <p>Type: Full time</p>
            <p>"Reliable plumbing solutions with a touch of expertise. We're your go-to team for fixing leaks and
