...
<body>
    ...
    <div class="services-container">
        <div class="service-card">
            ...
            <img src="domestic1.jpg" alt="Profile Photo">
            <h2>Name: Jyoti</h2>
            <p>Age: 30</p>
            <p>Gender: Female</p>
            <p>Type: Full time</p>
            <p>" With a keen eye for detail and X years of
                experience of dusting to disinfecting.
                keep things clean and fresh together!"
        ...
        <div class="service-card">
            ...
            <img src="domestic22.jpg" alt="Profile Photo">
            <h2>Name: Susmita Kumari</h2>
            <p>Age: 25</p>
            <p>Gender: Female</p>
